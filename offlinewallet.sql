...
-- Insert data into sender_info and recipient_info tables
INSERT INTO `sender_info` (`id`, `full_name`, `email`, `mobile`, `password`, `created_at`) 
VALUES 
(120, 'Monu Giri', 'whomonugiri@gmail.com', '7838403916', '123456', '2021-10-30 14:40:19'),
(121, 'Admin', 'admin@detym.com', '9999999999', '123456789', '2021-10-30 14:50:23'),
(122, 'Test Kumar', 'test@gmail.com', '9191919191', '123456', '2021-10-30 14:57:37'),
...
-- Insert data into recipient_info table
INSERT INTO `recipient_info` (`id`, `full_name`, `email`, `mobile`, `password`, `created_at`) 
VALUES 
(120, 'Monu Giri', 'whomonugiri@gmail.com', '7838403916', '123456', '2021-10-30 14:40:19'),
(121, 'Admin', 'admin@detym.com', '9999999999', '123456789', '2021-10-30 14:50:23'),
(122, 'Test Kumar', 'test@gmail.com', '9191919191', '123456', '2021-10-30 14:57:37'),
...
-- Insert data into wallet_balances table with initial balance of 0 for all users
...
-- Trigger to update sender and recipient wallet balances after each transaction
DELIMITER //

CREATE TRIGGER update_wallet_balances AFTER INSERT ON `trans`
FOR EACH ROW
BEGIN
    DECLARE sender_balance INT;
    DECLARE recipient_balance INT;

    -- Get sender's current balance
    SELECT `balance` INTO sender_balance FROM `wallet_balances` WHERE `user_id` = NEW.from_user_id;

    -- Update sender's balance
    UPDATE `wallet_balances` SET `balance` = sender_balance - NEW.amount WHERE `user_id` = NEW.from_user_id;

    -- Get recipient's current balance
    SELECT `balance` INTO recipient_balance FROM `wallet_balances` WHERE `user_id` = NEW.to_user_id;

    -- Update recipient's balance
    UPDATE `wallet_balances` SET `balance` = recipient_balance + NEW.amount WHERE `user_id` = NEW.to_user_id;
END;
//
